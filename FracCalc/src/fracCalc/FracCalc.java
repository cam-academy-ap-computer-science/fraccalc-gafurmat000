...
public class FracCalc {
		...
		public static void main(String[] args) {
			...
			while (!equation.toLowerCase().equals("quit")) {
				String results = produceAnswer1(equation);
		...
		public static String turnImproperFractionToMixedFraction(int numerator, int denominator) {
			...
			// Check to see if the result is a negative result and remove the "-" character from
    ...
    //      e.g. return ==> "1_1/4"
    	...
    	//My steps
    	// Set all Fractions to Improper Fractions 
